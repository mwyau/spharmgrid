...
- Extended JAX support to regular Gauss–Legendre grids with arbitrary valid longitude
  counts, with the longitude count independently setting the available zonal bandwidth.
