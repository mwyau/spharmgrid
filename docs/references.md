...
The {doc}`comparison` page lists NCL counterparts for spharmgrid filtering, regridding, scalar and vector differential operators, and atmospheric kinematics.
