...
- [torch-harmonics](https://github.com/NVIDIA/torch-harmonics) implements the PyTorch scalar and vector spherical harmonic transforms used by `spharmgrid.torch`.
